...
extension Button {
    ...
    static func action(_ id: String, _ label: String, _ icon: String,
                       _ actions: [Action] = []) -> Button {
    ...
    static func folder(_ id: String, _ label: String, _ icon: String,
                       contents: [Button]) -> Button {
        Button(id: id, label: label, icon: icon,
...
enum MockConfig {
    ...
    private static let appsPage = Page(
        ...
        buttons: [
            ...
            Button(id: "btn.app.terminal", label: nil, icon: "⌨️",
