...
11. **QR reconnect fallback** — on-demand QR redisplay + rescan-to-reconnect.
    ...
    1. (11a) **Pairing flow robustness.** Repurposed 2026-09-20 from the
       ...
       1 ("exactly one mobile device paired to exactly one desktop")
       stance not yet settled — narrow reading vs. reopening
       multi-desktop into v1, see PRD Open Question 2. Full scope lands
       in `docs/slices/11a. Pairing Flow Robustness.spec.md` once
       drafted.
